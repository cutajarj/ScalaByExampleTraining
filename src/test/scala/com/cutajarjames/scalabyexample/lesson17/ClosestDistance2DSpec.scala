...
class ClosestDistance2DSpec extends FlatSpec with Matchers {
  ...
  "The ClosestDistanceBruteSpec" should "output the correct value" in {
    ...
    ClosestDistance2D.closestDistance(points) shouldEqual 1.4142
  }
  ...
  it should "output the correct value with a larger list" in {
    ...
    ClosestDistance2D.closestDistance(points) shouldEqual 3.6055
  }
